...
use script::dom::element::{HTMLIframeElementTypeId, HTMLImageElementTypeId, HTMLUListElementTypeId, HTMLOListElementTypeId, ElementTypeId};
            ...
            ElementNodeTypeId(typeid) if typeid == HTMLUListElementTypeId || typeid == HTMLOListElementTypeId=> {
                match typeid {
                    ...
                    HTMLOListElementTypeId => {
                        ...
                        match node.with_element(|e: &LayoutElement| {e.get_attr(None, "start")}) {
                            Some(s) => {
